                ...
                <div class="col-lg-12">
                  <div class="card">
                    <div class="card-header"> Services
                      <a href="/admin/service/create" class="btn btn-success btn-sm pull-right">ADD</a>
                    </div>
                    <div class="card-body">
                      @if(count($services)>0)
                      <table class="table table-striped table-responsive-sm table-responsive-md">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>{{ $service->sermon_title }}</td>
                            <td>{{ $service->attendees }}</td>
                            
                            
                            <td>{{ $service->first_timers }}</td>
                            <td>{{ $service->givings }}</td>
                            
                            <td>
                              <a href="/admin/service/{{ $service->id }}/edit" class="btn btn-primary btn-sm">EDIT</a>
                      ...
                      @else
                      <h3><strong>There are no services registered</strong></h3>
                      @endif
