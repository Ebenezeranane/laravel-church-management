  ...
  <main class="page-content">
    ...
    <div class="form-group">
       ...
       {!! Form::label('income_title','Income',['class'=>'form-control ']) !!} 
                {!! Form::text('income_title', $income->income_title, ['class'=>'form-control','placeholder'=>'Income ']) !!} <br>
      


       {!! Form::label('income_amount','Amount',['class'=>'form-control ']) !!} 
                {!! Form::text('income_amount',$income->income_amount, ['class'=>'form-control','placeholder'=>'Amount']) !!} <br>


                 {!! Form::label('income_date','Income Date',['class'=>'form-control ']) !!} 
               {!! Form::date('income_date',$income->income_date, ['class'=>'form-control']) !!} <br><br>
