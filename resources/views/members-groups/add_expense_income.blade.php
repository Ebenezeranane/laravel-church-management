...
<div class="container">
    ...
    <div class="form-group">
        ...
        <h2> Income </h2>
             ...
             {!! Form::label('income_title','Income',['class'=>'form-control ']) !!} 
                {!! Form::text('income_title', '', ['class'=>'form-control','placeholder'=>'Income ']) !!} <br>
            


             {!! Form::label('income_amount','Amount',['class'=>'form-control ']) !!} 
                {!! Form::text('income_amount', '', ['class'=>'form-control','placeholder'=>'Amount']) !!} <br>


                 {!! Form::label('income_date','Income Date',['class'=>'form-control ']) !!} 
               {!! Form::date('income_date', \Illuminate\Support\Carbon::now(), ['class'=>'form-control']) !!} <br><br><br><br>
          

        
            <h2>Expenses</h2>
             {!! Form::label('expense_title','Expense',['class'=>'form-control ']) !!} 
                {!! Form::text('expense_title','', ['class'=>'form-control','placeholder'=>'Expense']) !!} <br>


                 {!! Form::label('expense_amount','Amount',['class'=>'form-control ']) !!} 
                {!! Form::text('expense_amount','', ['class'=>'form-control','placeholder'=>'Amount']) !!} <br>

                

                 {!! Form::label('expense_date','Expense Date',['class'=>'form-control ']) !!} 
               {!! Form::date('expense_date', \Illuminate\Support\Carbon::now(), ['class'=>'form-control']) !!} <br>
