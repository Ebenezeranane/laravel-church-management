...
<div class="page-wrapper toggled">
  ...
  <main class="page-content">
    ...
    <div class="form-group">
             {!! Form::open(['action'=>['GroupUnitsController@update',$group_units->id],'method'=>'POST']) !!}

            

                  
       {!! Form::label('group_units','Group/unit Name',['class'=>'form-control ']) !!} 
                {!! Form::text('group_units', $group_units->group_units, ['class'=>'form-control','placeholder'=>'Group/Unit Name']) !!} <br>
      


       {!! Form::label('members','Members',['class'=>'form-control ']) !!} 
                {!! Form::text('members', $group_units->members, ['class'=>'form-control','placeholder'=>'Members']) !!} <br>
       ...
       {!! Form::label('head','Head',['class'=>'form-control ']) !!} 
                {!! Form::text('head',$group_units->head, ['class'=>'form-control','placeholder'=>'Head']) !!} <br>
