  ...
  <main class="page-content">
    ...
    <div class="form-group">
             {!! Form::open(['method'=>'POST','action'=>'ServiceController@store']) !!}
               ...
               {!! Form::text('Title', '', ['class'=>'form-control','placeholder'=>'Service Title']) !!} <br>

                {!! Form::label('type','Type',['class'=>'form-control ']) !!} 
              {!! Form::select('type', ['Sunday Service'=>'Sunday Service','Watchnight Service'=>'Watchnight Service','Monday Service'=>'Monday Service'],'' ,['class'=>'form-control','placeholder'=>'-Service- ']) !!} <br>



             {!! Form::label('dateofbirth','Service Date',['class'=>'form-control ']) !!} 
               {!! Form::date('date', \Illuminate\Support\Carbon::now(), ['class'=>'form-control']) !!} <br>



            {!! Form::label('Venue','Venue',['class'=>'form-control ']) !!} 
                {!! Form::text('venue', '', ['class'=>'form-control','placeholder'=>'Venue']) !!} <br>
       ...
       {!! Form::label('Preacher','Preacher',['class'=>'form-control ']) !!} 
                {!! Form::text('preacher', '', ['class'=>'form-control','placeholder'=>'Name Of Preacher']) !!} <br>
    
    
      

    {!! Form::label('Sermon','Sermon Title',['class'=>'form-control ']) !!} 
                {!! Form::text('sermon_title', '', ['class'=>'form-control','placeholder'=>'Title Of Sermon']) !!} <br>
       ...
       {!! Form::label('Bible_text','Bible Text',['class'=>'form-control ']) !!} 
                {!! Form::text('bible_references','', ['class'=>'form-control','placeholder'=>'Bible References']) !!} <br>


      
      {!! Form::label('sermonNotes','Sermon Notes',['class'=>'form-control']) !!} 
                {!! Form::textarea('sermon_notes','', ['class'=>'form-control','placeholder'=>'Sermon Notes']) !!} <br>
      ...
      {!! Form::label('Attendance','Attendance',['class'=>'form-control ']) !!} 
                {!! Form::text('attendees', '', ['class'=>'form-control','placeholder'=>'Attendance']) !!} <br>

      

      {!! Form::label('firstTimers','First Timers',['class'=>'form-control ']) !!} 
                {!! Form::text('first_timers', '', ['class'=>'form-control','placeholder'=>'First Timers']) !!} <br>
        ...
        {!! Form::label('Givings','Givings',['class'=>'form-control ']) !!} 
                {!! Form::text('givings', '', ['class'=>'form-control','placeholder'=>'Givings']) !!} <br><br>
